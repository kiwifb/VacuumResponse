...
c     p: ( ixq; iyq;-iyq)
c     m: (-ixq; iyq;-iyq)
      double precision,dimension(nx,ny,nz,nt,0:nloop,nL(that))  :: WTp,WTm ! T-shape wilson loops
!HPF$ DISTRIBUTE WTp(*,*,BLOCK,BLOCK,*,*)
!HPF$ DISTRIBUTE WTm(*,*,BLOCK,BLOCK,*,*)
      double precision,dimension(nx,ny,nz,nt,0:nloop,nL(that))  :: WT4p,WT4m ! T-shape wilson loops
...
!HPF$ DISTRIBUTE upyi(*,*,BLOCK,BLOCK,*,*)
      double precision,dimension(nx,ny,nz,nt,1:nloop,nc,nc)     :: upxtr,upxti
