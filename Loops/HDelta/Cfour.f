...
c
      ...
      call multboxes(xdir,ydir, 0, 1,ilr,ili,hur,hui)
      call multboxes(xdir,ydir,-2, 2,ilr,ili,hur,hui)
...
c
      ...
      call multboxes(xdir,ydir, 0,-1,irr,iri,hdr,hdi)
      call multboxes(xdir,ydir,-2,-2,irr,iri,hdr,hdi)
