...
c
      double precision,dimension(nx,ny,nz,nt,nc,nc)           :: hur,hui
!HPF$ DISTRIBUTE hur(*,*,BLOCK,BLOCK,*,*)
!HPF$ DISTRIBUTE hui(*,*,BLOCK,BLOCK,*,*)
      double precision,dimension(nx,ny,nz,nt,nc,nc)           :: hdr,hdi
!HPF$ DISTRIBUTE hdr(*,*,BLOCK,BLOCK,*,*)
!HPF$ DISTRIBUTE hdi(*,*,BLOCK,BLOCK,*,*)
...
c
c     --------------------------
c     prepare the half 2x1 boxes
c     --------------------------
c
      hur = ixr
      hui = ixi
      call multboxes(xdir,ydir,-1, 0,hur,hui,ixr,ixi)
      hdr = hur
      hdi = hui
      call multboxes(xdir,ydir,-2, 0,hur,hui,uyr,uyi)
      call multboxes(xdir,ydir,-2, 0,hdr,hdi,dyr,dyi)
c
c     ---------------------------------
