...
!HPF$ DISTRIBUTE bmyli(*,*,BLOCK,BLOCK,*,*)
      double precision,dimension(nx,ny,nz,nt,nc,nc)                     :: c1r,c1i,c2r,c2i,c3r,c3i,c4r,c4i
...
!HPF$ DISTRIBUTE smyli(*,*,BLOCK,BLOCK,*,*)
      double precision,dimension(nx,ny,nz,nt,nc,nc)                     :: scr,sci
c
c     temporary arrays
c
...
c     ---------------------------------
      call boxm1m1(xdir,ydir,ur,ui,c1r,c1i)
      call boxm1p1(xdir,ydir,ur,ui,c2r,c2i)
      call boxp1p1(xdir,ydir,ur,ui,c3r,c3i)
      call boxp1m1(xdir,ydir,ur,ui,c4r,c4i)
...
c
         ...
         do ic = 1,nc
            do jc = 1,nc
               do kc = 1,nc
                  ...
                  tmpr(:,:,:,:,ic,jc) = tmpr(:,:,:,:,ic,jc)
     &                 + c1r(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc) - c1i(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc)

                  tmpi(:,:,:,:,ic,jc) = tmpi(:,:,:,:,ic,jc)
     &                 + c1r(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc) + c1i(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc)
         ...
         scr = 0.0d0
         sci = 0.0d0
         tlr = cshift(c1r,dim=that,shift=it)
         tli = cshift(c1i,dim=that,shift=it)
     ...
     &                 - tmpr(:,:,:,:,ic,kc) * tli(:,:,:,:,jc,kc) + tmpi(:,:,:,:,ic,kc) * tlr(:,:,:,:,jc,kc)
         ...
         do ic = 1,36
            ...
            Res(:,:,:,:) = Res(:,:,:,:)  + fper(ic) * (
     &           spxlr(:,:,:,:,la(ic),lap(ic)) * spylr(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &         - spxlr(:,:,:,:,la(ic),lap(ic)) * spyli(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - spxli(:,:,:,:,la(ic),lap(ic)) * spylr(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - spxli(:,:,:,:,la(ic),lap(ic)) * spyli(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &           )
...
c
         ...
         do ic = 1,nc
            do jc = 1,nc
               do kc = 1,nc
                  ...
                  tmpr(:,:,:,:,ic,jc) = tmpr(:,:,:,:,ic,jc)
     &                 + c2r(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc) - c2i(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc)

                  tmpi(:,:,:,:,ic,jc) = tmpi(:,:,:,:,ic,jc)
     &                 + c2r(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc) + c2i(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc)
         ...
         scr = 0.0d0
         sci = 0.0d0
         tlr = cshift(c2r,dim=that,shift=it)
         tli = cshift(c2i,dim=that,shift=it)
     ...
     &                 - tmpr(:,:,:,:,ic,kc) * tli(:,:,:,:,jc,kc) + tmpi(:,:,:,:,ic,kc) * tlr(:,:,:,:,jc,kc)
         ...
         do ic = 1,36
            ...
            Res(:,:,:,:) = Res(:,:,:,:)  + fper(ic) * (
     &           spxlr(:,:,:,:,la(ic),lap(ic)) * smylr(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &         - spxlr(:,:,:,:,la(ic),lap(ic)) * smyli(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - spxli(:,:,:,:,la(ic),lap(ic)) * smylr(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - spxli(:,:,:,:,la(ic),lap(ic)) * smyli(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &           )
...
c
         ...
         do ic = 1,nc
            do jc = 1,nc
               do kc = 1,nc
                  ...
                  tmpr(:,:,:,:,ic,jc) = tmpr(:,:,:,:,ic,jc)
     &                 + c3r(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc) - c3i(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc)

                  tmpi(:,:,:,:,ic,jc) = tmpi(:,:,:,:,ic,jc)
     &                 + c3r(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc) + c3i(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc)
         ...
         scr = 0.0d0
         sci = 0.0d0
         tlr = cshift(c3r,dim=that,shift=it)
         tli = cshift(c3i,dim=that,shift=it)
     ...
     &                 - tmpr(:,:,:,:,ic,kc) * tli(:,:,:,:,jc,kc) + tmpi(:,:,:,:,ic,kc) * tlr(:,:,:,:,jc,kc)
         ...
         do ic = 1,36
            ...
            Res(:,:,:,:) = Res(:,:,:,:)  + fper(ic) * (
     &           smxlr(:,:,:,:,la(ic),lap(ic)) * smylr(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &         - smxlr(:,:,:,:,la(ic),lap(ic)) * smyli(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - smxli(:,:,:,:,la(ic),lap(ic)) * smylr(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - smxli(:,:,:,:,la(ic),lap(ic)) * smyli(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &           )
...
c
         ...
         do ic = 1,nc
            do jc = 1,nc
               do kc = 1,nc
                  ...
                  tmpr(:,:,:,:,ic,jc) = tmpr(:,:,:,:,ic,jc)
     &                 + c4r(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc) - c4i(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc)

                  tmpi(:,:,:,:,ic,jc) = tmpi(:,:,:,:,ic,jc)
     &                 + c4r(:,:,:,:,ic,kc) * usti(:,:,:,:,kc,jc) + c4i(:,:,:,:,ic,kc) * ustr(:,:,:,:,kc,jc)
         ...
         scr = 0.0d0
         sci = 0.0d0
         tlr = cshift(c4r,dim=that,shift=it)
         tli = cshift(c4i,dim=that,shift=it)
     ...
     &                 - tmpr(:,:,:,:,ic,kc) * tli(:,:,:,:,jc,kc) + tmpi(:,:,:,:,ic,kc) * tlr(:,:,:,:,jc,kc)
         ...
         do ic = 1,36
            ...
            Res(:,:,:,:) = Res(:,:,:,:)  + fper(ic) * (
     &           smxlr(:,:,:,:,la(ic),lap(ic)) * spylr(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &         - smxlr(:,:,:,:,la(ic),lap(ic)) * spyli(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - smxli(:,:,:,:,la(ic),lap(ic)) * spylr(:,:,:,:,lb(ic),lbp(ic)) * sci(:,:,:,:,lc(ic),lcp(ic))
     &         - smxli(:,:,:,:,la(ic),lap(ic)) * spyli(:,:,:,:,lb(ic),lbp(ic)) * scr(:,:,:,:,lc(ic),lcp(ic))
     &           )
