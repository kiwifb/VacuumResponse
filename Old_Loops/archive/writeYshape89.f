...
c
      ...
      double precision,dimension(0:ny-1,0:nz-1,0:nt-1,8:nYloop,nL(that),offmax) :: TopAct
...
!HPF$ DISTRIBUTE form(BLOCK) onto linProcs
      double precision,dimension(8:nYloop,nL(that))            :: WYavg
