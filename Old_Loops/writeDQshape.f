...
c
      MODULE L_WRITEDQSHAPE

      CONTAINS

      subroutine writeDQshape(filename,TopAct,WYavg,avgTopAct,offmax)
      ...
      double precision,dimension(0:ny-1,0:nz-1,0:nt-1,0:ldq,nL(that),offmax) :: TopAct
...
!HPF$ DISTRIBUTE form(BLOCK) onto linProcs
      double precision,dimension(0:ldq,nL(that))            :: WYavg
...
c
      ...
      end subroutine writeDQshape

      END MODULE L_WRITEDQSHAPE 
