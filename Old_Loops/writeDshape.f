...
c     than one node.
c
c     F. Bissey 10 Jan. 2006
c
      MODULE L_WRITEDSHAPE

      CONTAINS

      subroutine writeDshape(filename,TopAct,WYavg,avgTopAct,offmax)
...
c'
      ...
      end subroutine writeDshape

      END MODULE L_WRITEDSHAPE 
